...
// Servo adjustment
#define _DUTY_MAX 1983  // Servo angle: D degree
#define _DUTY_NEU 1476  // Servo angle: 0 degree
#define _DUTY_MIN 880   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 80 // Replace with |D - E| degree
#define _SERVO_SPEED 2000 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 600
...
void loop() {
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(200, 0.5)); // Replace n with your desired value
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 737.0+(-3.26)*a_value + 5.14*0.001*a_value*a_value + (-2.89)*0.000001*a_value*a_value*a_value;
}
